...
extern "C" void KernelMainNewStack(
  ...
  InitializeTask();
  task_manager->NewTask().PushInitialStack(TaskB, 45).Wakeup();
  task_manager->NewTask().PushInitialStack(TaskIdle, 0xdeadbeef).Wakeup();
  task_manager->NewTask().PushInitialStack(TaskIdle, 0xcafebabe).Wakeup();
