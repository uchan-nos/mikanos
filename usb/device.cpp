...
namespace usb
{
  ...
  std::unique_ptr<Error> Device::ControlIn(EndpointID ep_id, SetupData setup_data,
  ...
  std::unique_ptr<Error> Device::ControlOut(EndpointID ep_id, SetupData setup_data,
  ...
  std::unique_ptr<Error> Device::InterruptIn(EndpointID ep_id, void *buf, int len)
  {
    return MAKE_ERROR(Error::kSuccess);
  }

  std::unique_ptr<Error> Device::InterruptOut(EndpointID ep_id, void *buf, int len)
  {
    return MAKE_ERROR(Error::kSuccess);
  }

  std::unique_ptr<Error> Device::StartInitialize()
  {
  ...
  std::unique_ptr<Error> Device::OnEndpointsConfigured()
  {
  ...
  std::unique_ptr<Error> Device::OnControlCompleted(EndpointID ep_id, SetupData setup_data,
  ...
  std::unique_ptr<Error> Device::OnInterruptCompleted(EndpointID ep_id, const void *buf, int len)
  {
  ...
  std::unique_ptr<Error> Device::InitializePhase1(const uint8_t *buf, int len)
  {
  ...
  std::unique_ptr<Error> Device::InitializePhase2(const uint8_t *buf, int len)
  {
  ...
  std::unique_ptr<Error> Device::InitializePhase3(uint8_t config_value)
  {
